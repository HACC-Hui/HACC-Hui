...
class EditProfileWidget extends React.Component {
        ...
        {restChoices.length > 0 ? (
          <React.Fragment>
            ...
            <Form.Group widths="equal">
              ...
              />
              <Dropdown
                ref={this.newToolLevelRef}
                options={levelChoices}
                placeholder="Choose a tool level"
              />
              <Button
                style={style}
                size="mini"
      ...
      <React.Fragment>
        ...
        {restChoices.length > 0 ? (
          <React.Fragment>
            ...
            <Form.Group widths="equal">
              <Dropdown
                ref={this.newSkillRef}
                options={restChoices}
                placeholder="Choose a skill"
              />
              <Dropdown
                ref={this.newSkillLevelRef}
                options={levelChoices}
  ...
  delTeamFunc = () => {
    const id = this.props.teams[0]._id;
    removeItMethod.call({
        ...
        <AutoForm schema={formSchema} model={model} onSubmit={this.submit}>
          <Form.Group widths="equal">
            ...
            {this.props.teams.map(team =>
              ...
              this.props.userSlug.map(userSlug =>
                team.owner == userSlug._id ? (
                  <Button
                    style={{ size: "200px" }}
                    color="red"
                    id={team._id}
                    content="Delete Team"
                    onClick={this.delTeamFunc}
                  >
...
export default withTracker(() => {
  ...
  const userSlug = Developers.find({}).fetch();
  return {
    allChallenges,
    allInterests,
    allSkills,
