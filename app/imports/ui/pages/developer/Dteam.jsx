 ...
 * @memberOf ui/pages
 */
class Dteam extends React.Component {
  name;
  ...
  getDeveloper(Teamname) {
    return Teams._collection.findOne({ Owner: Meteor.user().username } && {name = Teamname});
  }
