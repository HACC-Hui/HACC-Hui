...
class InterestedDevelopersCollection extends BaseCollection {

  constructor() {
    super('InterestedDevelopers', new SimpleSchema({
...
export const InterestedDevelopers = new InterestedDevelopersCollection();
