...
class ToAcceptWantToJoinCollection extends BaseCollection {

  constructor() {
    super('ToAcceptWantToJoin', new SimpleSchema({
...
export const ToAcceptWantsToJoin = new ToAcceptWantToJoinCollection();
